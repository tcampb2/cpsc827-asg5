...
funcdef // Used in: decorated, compound_stmt
	: DEF NAME { std::cout << $2 << " - function def name" << std::endl; } parameters COLON suite
	{ std::cout << $2 << " - function end" << std::endl;
	delete[] $2; }
	;
...
small_stmt // Used in: simple_stmt, star_SEMI_small_stmt
	: expr_stmt
	{ std::cout << "expr" << std::endl; } //HERE
	| print_stmt
	{ std::cout << "print" << std::endl; } //HERE
	| del_stmt
	| pass_stmt
	| flow_stmt
	| import_stmt
